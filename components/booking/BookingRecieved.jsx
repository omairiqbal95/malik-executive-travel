...
export default function BookingReceived() {
  ...
  const personalData = [
    { id: 1, topText: "First name", bottomText: passenger.firstName || "" },
    { id: 2, topText: "Last name", bottomText: passenger.lastName || "" },
    { id: 3, topText: "Email", bottomText: passenger.email || "" },
            ...
            <div className="box-booking-border wow fadeInUp">
              ...
              <div className="mt-20 mb-20 text-center">
                <Image
                  ...
                  src={selectedVehicle.imgSrc || "/assets/imgs/page/homepage1/e-class.png"}
              ...
              <ul className="list-prices">
                <li>
                  ...
                  <span className="text-bottom">{selectedVehicle.class || "Business Class"}</span>
                </li>
                <li>
                  <span className="text-top">Cars</span>
                  <span className="text-bottom">{selectedVehicle.title}</span>
                </li>
              </ul>
            </div>
          )}
